...
(function() {
  var a = this,
    b = b || {};
  b.WEBGL_RENDERER = 0, b.CANVAS_RENDERER = 1, b.VERSION = "v1.6", b.blendModes = {
    NORMAL: 0,
    ADD: 1,
    MULTIPLY: 2,
    SCREEN: 3,
    ...
    LINEAR: 0,
    NEAREST: 1
  }, b._UID = 0, b.Float32Array = Float32Array || Array, b.Uint16Array = Uint16Array || Array, b.INTERACTION_FREQUENCY = 30, b.AUTO_PREVENT_DEFAULT = !0, b.RAD_TO_DEG = 180 / Math.PI, b.DEG_TO_RAD = Math.PI / 180, b.dontSayHello = !1, b.sayHello = function(a) {
    if (!b.dontSayHello) {
      if (navigator.userAgent.toLowerCase().indexOf("chrome") > -1) {
        var c = ["%c %c %c Pixi.js " + b.VERSION + " - " + a + "  %c  %c  http://pixijs.com  %c %c â™¥%câ™¥%câ™¥ ", "background: #ff66a5", "background: #ff66a5", "color: #ff66a5; background: #030307;", "background: #ff66a5", "background: #ffc3dc", "background: #ff66a5", "color: #ff2424; background: #fff", "color: #ff2424; background: #fff", "color: #ff2424; background: #fff"];
  ...
  window.requestAnimationFrame || (window.requestAnimationFrame = function(a) {
    ...
    var b = a.texture,
      c = this.renderSession.blendModeManager.currentBlendMode !== a.blendMode;
    ...
    var c = a.tilingTexture,
      d = this.renderSession.blendModeManager.currentBlendMode !== a.blendMode;
    ...
    var f = a.tilePosition.x / (c.baseTexture.width * a.tileScaleOffset.x),
      g = a.tilePosition.y / (c.baseTexture.height * a.tileScaleOffset.y),
      h = a.width / c.baseTexture.width / (a.tileScale.x * a.tileScaleOffset.x),
      i = a.height / c.baseTexture.height / (a.tileScale.y * a.tileScaleOffset.y);
    ...
    if (0 !== this.currentBatchSize) {
      ...
      if (a.bindTexture(a.TEXTURE_2D, this.currentBaseTexture._glTextures[a.id] || b.createWebGLTexture(this.currentBaseTexture, a)), this.currentBaseTexture._dirty[a.id] && b.updateWebGLTexture(this.currentBaseTexture, a), this.currentBatchSize > .5 * this.size) a.bufferSubData(a.ARRAY_BUFFER, 0, this.vertices);
      else {
  ...
  function() {
    ...
    window.console || (window.console = {}, window.console.log = window.console.assert = function() {}, window.console.warn = window.console.assert = function() {}), b.Circle = function(a, b, c) {
      ...
      showDebugHeader: function() {
        ...
        if (this.renderType === b.WEBGL ? (c = "WebGL", e++) : this.renderType == b.HEADLESS && (c = "Headless"), this.device.webAudio && (d = "WebAudio", e++), this.device.chrome) {
          for (var f = ["%c %c %c Phaser v" + a + " | Pixi.js " + PIXI.VERSION + " | " + c + " | " + d + "  %c %c  http://phaser.io  %c %c â™¥%câ™¥%câ™¥ ", "background: #0cf300", "background: #00bc17", "color: #ffffff; background: #00711f;", "background: #00bc17", "background: #0cf300", "background: #00bc17"], g = 0; 3 > g; g++) f.push(e > g ? "color: #ff2424; background: #fff" : "color: #959595; background: #fff");
      ...
      if (c = c || 0, this.key = a, a instanceof b.RenderTexture) this.key = a.key, this.setTexture(a);
      else if (a instanceof b.BitmapData) this.setTexture(a.texture);
      ...
      else if ("string" != typeof a || this.game.cache.checkImageKey(a))
        ...
        } else this.setTexture(new PIXI.Texture(PIXI.BaseTextureCache[a]));
      else this.key = "__missing", this.setTexture(PIXI.TextureCache[this.key]);
    ...
    }, b.Image.prototype.bringToTop = b.Sprite.prototype.bringToTop, Object.defineProperty(b.Image.prototype, "angle", {
      get: function() {
        return b.Math.wrapAngle(b.Math.radToDeg(this.rotation))
      },
      set: function(a) {
      ...
      addSpriteSheet: function(a, c, d, e, f, g, h, i) {
        this._images[a] = {
          ...
          margin: h,
          spacing: i
        }, PIXI.BaseTextureCache[a] = new PIXI.BaseTexture(d), this._images[a].frameData = b.AnimationParser.spriteSheet(this.game, a, e, f, g, h, i)
      },
      ...
      addBitmapFont: function(a, c, d, e, f, g) {
        this._images[a] = {
          ...
          data: d,
          spriteSheet: !0
        }, PIXI.BaseTextureCache[a] = new PIXI.BaseTexture(d), b.LoaderParser.bitmapFont(this.game, e, a, f, g)
      },
      ...
      addImage: function(a, c, d) {
        this._images[a] = {
          ...
          data: d,
          spriteSheet: !1
        }, this._images[a].frame = new b.Frame(0, 0, 0, d.width, d.height, a, this.game.rnd.uuid()), PIXI.BaseTextureCache[a] = new PIXI.BaseTexture(d)
      },
  ...
  }, Phaser.Physics.P2.RevoluteConstraint.prototype = Object.create(p2.RevoluteConstraint.prototype), Phaser.Physics.P2.RevoluteConstraint.prototype.constructor = Phaser.Physics.P2.RevoluteConstraint; //# sourceMappingURL=phaser.map
